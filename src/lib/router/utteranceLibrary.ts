...
export const ROUTE_DEFINITIONS: RouteDefinition[] = [
  ...
  },
  {
    ...
    priority: 85,
    description:
      'User wants Jarvis to control the desktop, click UI, move the mouse, use apps outside the browser, or automate OS tasks',
    utterances: [
  ...
  },
  {
    ...
    priority: 80,
    description: 'User wants to run PowerShell, terminal commands, or system administration',
    utterances: [
      'run this command',
      'open PowerShell',
      'execute in terminal',
  ...
  {
    name: 'automation_mode_switch',
    priority: 95,
    description: 'User wants Jarvis to take control vs guide them step by step',
    utterances: [
      'take control',
      'do it for me',
      'autopilot',
